  ...
  <div class="row settings_section">
    ...
    <div class="column col-6 m-12">
      ...
      <fieldset>
        ...
        <p class="setting_description">Enabling this option will create a widget that you can use. Go to <i>Appearance > Widgets</i> and find the widget named <strong>WPFL Social Sharing</strong>.</p>
    ...
    <div class="column col-6 m-12">
      ...
      <fieldset>
        ...
        <p class="setting_description">Use the shortcode <strong>[wpfl-social-sharing]</strong> to add social sharing buttons any where you want in your content.</p>
      </fieldset>
      
      <fieldset>
        <label>Using The Shortcode In Your Theme</label>
        <p class="setting_description">Use the following PHP code to add social sharing buttons any where you want in your theme.</p>
        <p><code>do_shortcode('[wpfl-social-sharing]');</code></p>
      </fieldset>
    </div>
  </div>
  ...
  <div class="row settings_section">
    ...
    <div class="column col-6 m-12">
      ...
      <fieldset>
        ...
        <br>
        <input type="checkbox" name="wpfl_social_sharing_display_template_archives" value="1" <?php checked( '1', get_option( 'wpfl_social_sharing_display_template_archives' ) ); ?> /> Archives/Categories
      </fieldset>
    </div>
  </div>
